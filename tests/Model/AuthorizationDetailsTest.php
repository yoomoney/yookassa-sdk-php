...
class AuthorizationDetailsTest extends TestCase
{
    ...
    public function testGetSetThreeDSecure($authorizationDetails)
    {
        ...
        $threeDSecureExpect = is_object($authorizationDetails['three_d_secure'])
            ? ($authorizationDetails['three_d_secure'])->getApplied()
            : $authorizationDetails['three_d_secure']['applied'];
